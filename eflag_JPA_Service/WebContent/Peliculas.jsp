...
<body>
	<div class="container">
				...
				<form id="filter" action="filter" class="filter-form" method="post">
					Realiza un Busqueda <select name="genero">
						<%
							...
							if (user != null) {
								listFavorites = (List<Pelicula>) user.getFavoritos();
						%>
		...
		<h1>esta lista de pelicula fue solicitada desde el SERVICIO REST</h1>
		<form id="formRest" onsubmit="viewMovies(event)" >
					Realiza un Busqueda
					<select id="gender">
						<option name="Todas" value="todas">Todas</option>
						<option name="Animación" value="animacion">Animación</option>
		...
		<div id="moviesService" class="movies">
